...
public partial class TransformInterpreter
{
	...
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	private MonoBehaviour				m_tOwnerInstance	= null;
	...
	{
		return (m_tOwnerInstance.transform != null) ? m_tOwnerInstance.transform :  m_tInstance;
	}
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	//	* Accessors
	//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
public partial class TransformInterpreter
{
	public class WorldPositionInterpreter
	{
		...
		{
			get { return m_tiInstance.GetTransform().position; }
			set { m_tiInstance.GetTransform().position = value; }
		}

		public float x
		{
			get { return Value.x; }
			set { Value = new Vector3(value, this.y, this.z); }
		}

		public float y
		{
			get { return Value.y; }
			set { Value = new Vector3(this.x, value, this.z); }
		}

		public float z
		{
			get { return Value.z; }
			set { Value = new Vector3(this.x, this.y, value); }
		}
	}
}
...
public partial class TransformInterpreter
{
	public class LocalPositionInterpreter
	{
		...
		public Vector3 Value
		{
			get { return m_tiInstance.GetTransform().localPosition; }
			set { m_tiInstance.GetTransform().localPosition = value; }
		}
...
public partial class TransformInterpreter
{
	public class WorldRotationInterpreter
	{
		...
		{
			m_tiInstance.GetTransform().rotation = new Quaternion(a.x, a.y, this.z, this.w);
		}

		public void Set(Vector3 a)
		{
			m_tiInstance.GetTransform().rotation = new Quaternion(a.x, a.y, a.z, this.w);
		}

		public void Set(Vector4 a)
		{
			m_tiInstance.GetTransform().rotation = new Quaternion(a.x, a.y, a.z, a.w);
		}
...
public partial class TransformInterpreter
{
	public class ScaleInterpreter
	{
		...
		public Vector3 Value
		{
			get { return m_tiInstance.GetTransform().localScale; }
			set { m_tiInstance.GetTransform().localScale = value; }
		}
